...
const Home: React.FC = () => {
  ...
  const handleGoToContact = () => {
    const event = new CustomEvent('navigateSection', { detail: { direction: 'goto', section: 'contact' } });
          ...
          <div className="flex space-x-4">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8.5 19.5L15.5 12.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </motion.a>
            <motion.a
              whileHover={{ scale: 1.1, y: -2 }}
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              href="#"
              onClick={e => { e.preventDefault(); handleGoToContact(); }}
              className="p-3 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-gray-700 dark:text-gray-300"
            >
              <Mail size={24} />
            </motion.a>
